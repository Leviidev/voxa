...
// Linux frameless window — inject drag region + window controls (same as Windows)
window.addEventListener('DOMContentLoaded', () => {
  ...
  btns.forEach(({ label, action, hoverBg, hoverColor }) => {
    ...
    btn.addEventListener('mouseleave', () => { btn.style.background = 'transparent'; btn.style.color = 'rgba(255,255,255,0.7)' })
